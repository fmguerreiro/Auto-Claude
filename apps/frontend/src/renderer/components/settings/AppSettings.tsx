...
export type AppSection = 'appearance' | 'display' | 'language' | 'devtools' | 'agent' | 'paths' | 'integrations' | 'api-profiles' | 'ssh-servers' | 'updates' | 'notifications' | 'debug';
